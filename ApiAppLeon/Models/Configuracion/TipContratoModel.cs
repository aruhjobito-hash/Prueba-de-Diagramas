...
// Developer: feragu 04/06/2025 - Controlador para control de Tipo  de contrato del Trabajador
...
{
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá el endpoint en el controlador: TipContrato 
    /// </summary>
    public class requestTipContratoModel
    {
        [Required(ErrorMessage = "El campo IdTipContrato es obligatorio")]
        [MaxLength(2, ErrorMessage = "El campo IdTipContrato no puede tener más de 2 caracteres")]
        //[MinLength(2, ErrorMessage = "El campo IdTipContrato debe tener al menos 2 caracteres")]
        public string IdTipContrato { get; set; }
    ...
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá los datos del store procedure: sp_TipContrato 
    /// </summary>
    [Keyless]
    public class TipContratoDBModel
    {
