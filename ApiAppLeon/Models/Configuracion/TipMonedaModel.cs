...
// Developer: feragu 04/06/2025 - Controlador para control de Tipos de moneda
...
{
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá el endpoint en el controlador: TipMoneda 
    /// </summary>
    public class requestTipMonedaModel
    {
   
        [Required(ErrorMessage = "El campo IdTipMoneda es obligatorio")]
        [MaxLength(2, ErrorMessage = "El campo IdTipMoneda no puede tener más de 2 caracteres")]
        [MinLength(1, ErrorMessage = "El campo IdTipMoneda debe tener al menos 2 caracteres")]
        public string IdTipMoneda { get; set; }
    ...
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá los datos del store procedure: sp_TipMoneda 
    /// </summary>
    [Keyless]
    public class TipMonedaDBModel
    {
        ...
        [Required(ErrorMessage = "El campo IdTipMoneda es obligatorio")]
        [MaxLength(2, ErrorMessage = "El campo IdTipMoneda no puede tener más de 2 caracteres")]
        //[MinLength(2, ErrorMessage = "El campo IdTipMoneda debe tener al menos 2 caracteres")]
        public string IdTipMoneda { get; set; }
