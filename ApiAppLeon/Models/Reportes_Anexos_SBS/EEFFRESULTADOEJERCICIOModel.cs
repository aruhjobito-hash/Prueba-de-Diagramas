...
// Developer: VicVil 17/06/2025 - Controlador para Generar EEFF RESULTADO EJERCICIO
...
{
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá el endpoint en el controlador: EEFFRESULTADOEJERCICIO 
    /// </summary>
    public class requestEEFFRESULTADOEJERCICIOModel
    {
    ...
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá los datos del store procedure: sp_EEFFRESULTADOEJERCICIO 
    /// </summary>
    [Keyless]
    public class EEFFRESULTADOEJERCICIODBModel
    {
        public long? IdResultadoEjercicioDetalle { get; set; } = 0;
        public long? IdResultadoEjercicio { get; set; } = 0;
