...
// Developer: VicVil 10/06/2025 - Controlador para Generar Reporte 1
...
{
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá el endpoint en el controlador: Reporte1 
    /// </summary>
    ...
    /// <summary>
    /// Esta clase contiene el modelo (objeto) que recibirá los datos del store procedure: sp_Reporte1 
    /// </summary>
    [Keyless]
